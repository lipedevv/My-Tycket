...
inquiry_options() {
  ...
  printf "\n\n"
  printf "   [0] Instalar Whaticket Plus\n"
  printf "   [1] Atualizar Whaticket Plus\n"
  printf "   [2] Deletar Whaticket Plus\n"
  printf "   [3] Bloquear Whaticket Plus\n"
  printf "   [4] Desbloquear Whaticket Plus\n"
  printf "   [5] Alter. dominio Whaticket Plus\n"
  printf "\n"
  read -p "> " option
